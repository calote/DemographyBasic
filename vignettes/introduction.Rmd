...
<!-- # a: Traduce al inglés: Se utiliza la función DemBas_read_px2() para leer ficheros px. Por ejemplo, para leer el fichero 9663.px que se encuentra en la carpeta examples del paquete DemographyBasic se puede hacer: -->

The function `DemBas_read_px2()` is used to read px files. For example, to read the file 9663.px that is located in the examples folder of the DemographyBasic package, you can do:
...
```{r}
dfej02b = DemBas_read_px2(system.file("examples/1489.px", package = "DemographyBasic"))
...
```{r}
dfej02c = DemBas_read_px2(system.file("examples/1452.px", package = "DemographyBasic"))
head(dfej02c)
```
