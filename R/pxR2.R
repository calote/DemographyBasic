...
#' # example code
#' # Importing a .px file
#' example_data_px <- DemBas_read_px2(system.file("examples/56940.px", package = "DemographyBasic"))
#' head(example_data_px)
#' @export
DemBas_read_px2 <- function(filename, encoding = NULL, 
                     na.strings = c('"."', '".."', '"..."', '"...."', '":"')) {
