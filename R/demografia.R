...
#'   por grupo de edad. Deben estar expresadas en tasas por 1
#'   (no por 1000).
#' @param amplitud_intEdad Valor numérico con la amplitud del intervalo
#'   de grupos de Edad (por defecto, es 1 para edades simples, pero si
#'   las tasas son para grupos quinquenales, se debe usar 5).
#'
#' @return Valor numérico con el número medio de sucesos por individuo.
#'
#' @examples
...
#'
#' @export
DemBas_dem_ISinteticoCoyuntural_t <- function(vTasasEspecificas_x_t, amplitud_intEdad = 1) {
  return(sum(vTasasEspecificas_x_t * amplitud_intEdad, na.rm = TRUE))
}
